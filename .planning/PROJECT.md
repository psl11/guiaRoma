...
---
*Last updated: 2026-06-21 — Fase 5 completada (navegación transversal: `useCardNavigation` singleton — scroll-a-ficha con resaltado 2,5 s, pila de "volver" que restaura el scroll, scrollspy `scrollY+130` last-wins sin IntersectionObserver, e intercepción por delegación en fase de captura de los enlaces de ficha; Pitfall NuxtLink/onMounted-tras-await resuelto; paridad verificada con spec Playwright autocontenido 6/6 + sign-off humano)*
