...
---
*Last updated: 2026-06-20 — Fase 4 completada (render data-driven de fichas, timeline despachado por `kind`, secciones de referencia y los 3 modos de ritmo; D1 resuelto — colecciones-unión `artist`/`reference` materializadas vía esquemas superset; paridad de render verificada con specs DOM/comportamiento + sign-off humano)*
